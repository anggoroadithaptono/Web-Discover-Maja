<html>
  ...
  <section class="orang-section">
    <div class="orang-block">
      <div class="orang-img" data-aos="fade-right">
        <img src="{{ asset('images/wahyu.png') }}" alt="wahyu">
      </div>
      <div class="orang-text" data-aos="fade-left">
        <h2>Wahyu Pratama Andhika M.</h2>
        <p>23082010015</p>
      </div>
    </div>

    <div class="orang-block reverse">
      <div class="orang-img" data-aos="fade-left">
        <img src="{{ asset('images/anggoro.png') }}" alt="alvian">
      </div>
      <div class="orang-text" data-aos="fade-right">
        <h2>Anggoro Adit Haptono</h2>
        <p>23082010006</p>
      </div>
    </div>
    ...
    <div class="orang-block">
      <div class="orang-img" data-aos="fade-right">
        <img src="{{ asset('images/jay.png') }}" alt="anggoro">
      </div>
      <div class="orang-text" data-aos="fade-left">
        <h2>Muhammad Alvian Jaya</h2>
        <p>23082010019</p>
      </div>
    </div>
  </section>
